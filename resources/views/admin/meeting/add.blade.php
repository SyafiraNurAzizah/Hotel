                ...
                <form action="{{ route('admin.meeting.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="number" class="form-control" id="jumlah_ruang_tersedia"
                                name="jumlah_ruang_tersedia" required>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="number" class="form-control" id="ukuran_ruangan" name="ukuran_ruangan"
                                required>
                        </div>
                        <div class="form-group mt-3">
