...
<link rel="stylesheet" href="{{ asset('css/meeting/transaksi/lokasi.css') }}">
...
<div class="sidebar-pembayarannt">
    <a href="{{ route('meeting.transaksi.lokasi-meeting', ['location' => strtolower($hotel->nama_cabang), 'roomId' => $meetings->id, 'uuid' => $booking->uuid]) }}" class="active">
        <p class="bi bi-map">
