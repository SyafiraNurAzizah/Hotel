...
<link rel="stylesheet" href="{{ asset('css/meeting/transaksi/pembayaran.css') }}">
...
<div class="container">
    ...
    @if ($pembayaran->metode_pembayaran == 'DANA' || $pembayaran->metode_pembayaran == 'OVO' || $pembayaran->metode_pembayaran == 'BCA' || $pembayaran->metode_pembayaran == 'BRI' || $pembayaran->metode_pembayaran == 'BNI' || $pembayaran->metode_pembayaran == 'Mandiri')
            ...
            <div class="bukti-form">
                ...
                @foreach ($hotels as $hotel)
                    <div class="bukti-pembayaran">
                        <p>Bukti Pembayaran</p>
                        <form action="{{ route('booking.meeting.pembayaran.update', ['location' => strtolower($hotel->nama_cabang), 'roomId' => $meetings->id, 'uuid' => $booking->uuid]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
        ...
        <div class="overlay" id="buktiOverlay">
            <div class="bukti" style="width: 500px; height: auto; border-radius: 4px;">
...
<div class="sidebar-pembayarannt">
    ...
    <a href="{{ route('meeting.transaksi.transaksi-meeting', ['location' => strtolower($hotel->nama_cabang), 'roomId' => $meetings->id, 'uuid' => $booking->uuid]) }}">
...
<div class="sidebar">
    ...
    <a href="{{ route('meeting.transaksi.pembayaran-meeting', ['location' => strtolower($hotel->nama_cabang), 'roomId' => $meetings->id, 'uuid' => $booking->uuid]) }}" class="active">
